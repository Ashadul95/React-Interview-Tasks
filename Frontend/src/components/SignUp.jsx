...
const SignUp = () => {
    ...
    return (
        <div className="flex flex-col lg:flex-row min-h-screen border-8 p-8  bg-gray-300">
            ...
            <div className="w-full lg:w-1/2 bg-gray-800 text-white p-10 flex flex-col justify-center rounded-l-2xl">
            ...
            {/* Right Section */}
            <div className="w-full lg:w-1/2 bg-white p-10 flex flex-col justify-center rounded-r-2xl">
                ...
                <form onSubmit={handleSubmit(submit)}>
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            {...register("user_firstname",{required:{value:true,message:"First name is required."},minLength:{value:4,message:"Min length is 4"},maxLength:{value:20,message:"Max length is 20"}})}
                        />
                        {errors.user_firstname && <div className='text-red-700 text-md mb-2'>{errors.user_firstname.message}</div>}
                    </div>
                    <div className="mb-4">
                        <label className="block text-gray-700 text-sm font-bold mb-1" htmlFor="name">
                        ...
                        <input
                            ...
                            {...register("user_lastname",{required:{value:true,message:"Last name is required."},minLength:{value:4,message:"Min length is 4"},maxLength:{value:20,message:"Max length is 20"}})}
                        />
                        {errors.user_lastname && <div className='text-red-700 text-md mb-2'>{errors.user_lastname.message}</div>}
                    </div>
                    <div className="mb-4">
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            {...register("user_city",{required:{value:true,message:"City name is required."},minLength:{value:4,message:"Min Length is 4"},maxLength:{value:20,message:"Max length is 20"}})}
                        />
                        {errors.user_city && <div className='text-red-700 text-md mb-2'>{errors.user_city.message}</div>}
                    </div>
                    <div className="mb-4">
                        <label className="block text-gray-700 text-sm font-bold mb-1" htmlFor="zipCode">
                            Zipcode
                        </label>
                        <input
                            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            ...
                            type="number"
                            placeholder="Zipcode"
                            {...register("user_zipcode",{required:{value:true,message:"Zipcode is required."},minLength:{value:6,message:"Min Length is 6"},maxLength:{value:8,message:"Max length is 8"}})}
                        />
                        {errors.user_zipcode && <div className='text-red-700 text-md mb-2'>{errors.user_zipcode.message}</div>}
                    </div>
                    <div className="mb-4">
                        <label className="block text-gray-700 text-sm font-bold mb-1" htmlFor="zipCode">
                            Phone number
                        ...
                        <input
                            ...
                            {...register("user_phone",{required:{value:true,message:"phone number is required."},minLength:{value:10,message:"Min Length is 10"},maxLength:{value:13,message:"Max length is 13"}})}
                        />
                        {errors.user_phone && <div className='text-red-700 text-md mb-2'>{errors.user_phone.message}</div>}
                    </div>
                    <div className="mb-4">
                        <label className="block text-gray-700 text-sm font-bold mb-1">
                            <input className="mr-2 leading-tight" type="checkbox" 
                            {...register("PrivacyPolicy",{required:{value:true,message:"Privacy Policy check is required."}})}
                            />
                            <span className="text-sm">I agree to the Terms of Service and Privacy Policy</span>
                            {errors.PrivacyPolicy && <div className='text-red-700 text-md mb-2'>{errors.PrivacyPolicy.message}</div>}
                        </label>
                    </div>
